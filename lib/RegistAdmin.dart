...
void main(List<String> args) {
  runApp(MyRegistAdmin());
}

class MyRegistAdmin extends StatelessWidget {
  const MyRegistAdmin({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: HomeMyRegistAdmin(),
    );
  }
}

class HomeMyRegistAdmin extends StatefulWidget {
  HomeMyRegistAdmin({Key key}) : super(key: key);

  @override
  _HomeMyRegistAdminState createState() => _HomeMyRegistAdminState();
}

class _HomeMyRegistAdminState extends State<HomeMyRegistAdmin> {
