...
class FeaturedCardMostWanted extends StatelessWidget {
  ...
  FeaturedCardMostWanted({@required this.name,@required this.id,@required this.picture});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: (){
          Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(builder: (context) => new MyDetailPaketKonsumen(value: id,)));
        },
        child: Container(
