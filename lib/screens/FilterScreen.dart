...
class FiltersScreen extends StatefulWidget {
  final String num1;
  final String num2;
  FiltersScreen({Key key, this.num1,this.num2}) : super(key:key);
  @override
...
class _FiltersScreenState extends State<FiltersScreen> {
  ...
  RangeValues _values = RangeValues(100, 600);//DEFINE VARIABLE data DENGAN TYPE List AGAR DAPAT MENAMPUNG COLLECTION / ARRAY
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      {
                        Navigator.of(context, rootNavigator: true).pushReplacement(MaterialPageRoute(builder: (context) => new home_paket(value: _listViewDataJenis,murah: _values.start,mahal: _values.end,filter: "jenis",)));
                      }
                      else
                      {
                        Navigator.of(context, rootNavigator: true).pushReplacement(MaterialPageRoute(builder: (context) => new home_paket(value: _listViewDataTema,murah: _values.start,mahal: _values.end,filter: "tema",)));
                      }
