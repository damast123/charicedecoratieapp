...
class DatumLegendWithMeasures extends StatelessWidget {
  ...
  factory DatumLegendWithMeasures.withSampleData(
      String jumlahUntung, String jumlahRugi) {
    return new DatumLegendWithMeasures(
      _createSampleData(jumlahUntung, jumlahRugi),
  ...
  static List<charts.Series<LinearSales, String>> _createSampleData(
      String numberUntung, String numberRugi) {
    int setUntung = int.parse(numberUntung);
    int setRugi = int.parse(numberRugi);
    final data = [
      new LinearSales('Untung', setUntung),
      new LinearSales('Rugi', setRugi),
    ];
